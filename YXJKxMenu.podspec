...
Pod::Spec.new do |s|
  ...
  s.screenshots      = "http://120.27.93.73/files/myPublicProject/YXJKxMenu1.gif"
  s.license          = 'Apache License, Version 2.0'
  s.author           = { "stubbornness1219" => "18223847097@163.com" }
  s.source           = { :git => "https://github.com/stubbornnessness/YXJKxMenu.git", :tag => s.version.to_s }
  # s.source           = { :git => "/Users/yxj/Documents/YXJKxMenu"}
  # s.social_media_url = 'https://twitter.com/yxj'
  s.platform     = :ios
  s.ios.deployment_target = '8.0'
  s.requires_arc = true
  s.module_name = "YXJKxMenu"
